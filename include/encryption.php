...
class Encryption {
    ...
    public function __construct ()
    {
        ...
        // first character of the password is also the first character in $scramble1).
       	 $this->scramble1 = '! *,-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz|!';
         $this->scramble2 = 'fjAEokIOzU2q13h5w_794p6s8BgPdFVm DTcSZe|rlGKuCy.JxHiQ!Lt-RMa,NvWYnb*0Xf';
...
function ENCRYPT_DECRYPT($Str_Message) {
    ...
    FOR ($Position = 0;$Position<$Len_Str_Message;$Position++){
        ...
        $Key_To_Use = (($Len_Str_Message+$Position));
       
        $Key_To_Use = (200+$Key_To_Use) % 200;
