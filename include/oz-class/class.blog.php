...
class Blogs extends Database{
    ...
    public function get_recent_blogs ($limit=0) {
        $limiter = $limit ? " LIMIT $limit" : "";
        $sql = "SELECT * FROM blogs ORDER BY id DESC $limiter";
    ...
    public function get_categories () {
        $sql = "SELECT * FROM category WHERE 1=1 ORDER BY id DESC";
        if ( $obj = $this->db_fetch_obj($sql) ){
            return $obj;
        }
        return $obj;
